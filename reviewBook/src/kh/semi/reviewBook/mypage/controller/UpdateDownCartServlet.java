...
/**
 * Servlet implementation class UpdateDownCartServlet
 */
@WebServlet("/updatedown")
public class UpdateDownCartServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateDownCartServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new MyPageService().downUpdateCart(cvo);
		if (result < 1) {
