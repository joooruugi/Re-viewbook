...
/**
 * Servlet implementation class FundingSeriesCommentDeleteServlet
 */
@WebServlet("/fundingseriescommentdelete")
public class FundingSeriesCommentDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FundingSeriesCommentDeleteServlet() {
        super();
