...
//	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AdminVo avo = new AdminService().findidAdmin(adNickname, adEmail);
		if (avo == null) { // 아이디 찾기 실패
			...
			request.setAttribute("adId", avo.getAdId());
			System.out.println(adNickname);
			script.println("<script>");
			script.println("alert('"+adNickname+"님의 아이디는 "+avo.getAdId()+"입니다.')");
