					...
					<tr>
						<td>
							<ul>
									...
									<div class="bbs_board">
										<div class="bbs_title">
											<a href="adseriesread?wbNo=${svo.wbNo}"> ${svo.wbTitle}
												[${svo.reCommentCnt}]</a> <span>${svo.wbWriter}</span>
										...
										<div class="bbs_content">
											<p>
												<a href="adseriesread?wbNo=${svo.wbNo}">${svo.wbContent}</a>
											</p>
										</div>
										<div class="bbs_date_ctgory">${svo.wbDate}
											<span>${svo.wbCategory}</span> &nbsp; &nbsp; <span><i class="xi-eye-o"></i>&nbsp;${svo.wbCount}</span>
										</div>
										<br>
										</li>
									</div> 
