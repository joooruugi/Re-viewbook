<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/subscribe/adsubscribe.css">
<link rel="stylesheet"
		...
		<div class="bodyrvb">
			<nav class="sidemenu">
				<ul class="sidemenu_subscribe">
					...
					<li><a class="sidemenu_item" href="adsubscribemain">구독 회원
							조회</a></li>
					<li><a class="sidemenu_item" href="adsubscribedel">철회 회원
							조회</a></li>
				</ul>
			</nav>
