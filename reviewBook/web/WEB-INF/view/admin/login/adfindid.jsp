<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/signlogin/loginuser_findid.css">
<link rel="stylesheet"
...
<body>
	...
	<div class="loginuser_findid_body">
		<div class="loginuser_findid_content">
			...
			<form action="<%=request.getContextPath()%>/ad_findid.lo"
				method="post">
				...
				<div class="loginuser_findid_input">
					<input type="text" name="adNickname" required="required"> <input
						type="text" name="adEmail" required="required">
				</div>
