        ...
        <div class="loginuser_content">
			<form action="<%=request.getContextPath()%>/login.lo" method="post">
				...
				<div class="loginuser_input">
					<input type="text" name="usId" required="required"> <input
						type="password" name="usPassword" required="required">
				</div>
				<div class="loginuser_link_find">
					<a class="loginuser_link_find_id"
						href="<%=request.getContextPath() %>/findid">
						<p class="fontnothing">아이디 찾기</p>
					</a> <a class="loginuser_link_find_pw"
						href="<%=request.getContextPath() %>/findpwd">
