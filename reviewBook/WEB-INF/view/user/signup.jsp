...
<body>
	<form name="frmRegister">
		아이디:<input type="text" name="usId" id="usId" required="required" placeholder="영문자, 숫자를 사용한 6자이상 20자이하"> <button type="button" id="idCheck">중복체크</button><br>
		...
		이메일:<input type="email" name="usEmail" id="usEmail" required="required"><br>
